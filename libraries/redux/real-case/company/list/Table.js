...
// ** Store & Actions
import { getAllData, getData } from '../company/store'
...
// ** Utils
import { selectThemeColors, fetchOptionsDefault, fetchConstantDefault } from '@utils'
...
const CompanyList = () => {
  ...
  useEffect(() => {
    ...
    fetchConstantDefault({
      url: '/constant/package',
      name: 'Plan',
      label: 'name',
      value: 'id',
      dispatch: setPlanOptions
    })
  }, [])
